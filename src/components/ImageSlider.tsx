...
export function ImageSlider({ urls }: ImageSliderProps) {
  ...
  const activeStyles =
    'active:scale-[0.97] grid opactity-100 hover:scale-105 absolute top-1/2 -translate-y-1/2 aspect-square h-8 w-8 z-50 place-items-center rounded-full bg-white'
